describe("SpeciesView", function() {
  ...
  describe("displaySpeciesComparison", function() {
    beforeEach(function() {
      var comparisonData = {"species_one":{"id":1,"name":"Arapawa Island Goat","scientific_name":"Capra aegagrus hircus","maori_name":null,"description":"Native. A rare goat breed, originating from Arapawa Island in the Marlborough Sounds.","id_male":"Flat, wide sweeping horns. Black striped facial markings. A variety of colours (white, tan, brown and black are common).","id_female":"Shorter horns that curve backwards over the head. Similar coat markings to the male.","id_juvenile":"Similar colouring to the adults, but with horn buds rather than full horns.","image_url":"https://s3-ap-southeast-2.amazonaws.com/wildlifesite/GoatKid.jpg","image_caption":"Arapawa Island Goat Kid at Staglands Wildlife Reserve. 2014. (c) Kelly Munro."},"species_two":{"id":2,"name":"Australasian Bittern","scientific_name":"Botaurus poiciloptilus","maori_name":"Matuku hurepo","description":"Native. Large stocky bird with dark-brown and beige plumage.","id_male":"Mottled brown and beige body.","id_female":"Similar colouring to the male. The female is less vocal than the male.","id_juvenile":"Lighter brown which darkens with age.","image_url":null,"image_caption":null}};
